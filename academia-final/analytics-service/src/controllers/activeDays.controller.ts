/**
 * @file Controlador de `activeDays`, sobre la tabla `analitica_dias_activos`.
 *
...
import service from '#services/activeDays.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `analitica_dias_activos`.
 */
export default new ResourcesController(service, 'analitica_dias_activos');
