/**
 * @file Controlador de `whatsapp`, sobre la tabla `notificaciones_registros`.
 *
...
import service from '#services/whatsapp.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `notificaciones_registros`.
 */
export default new ResourcesController(service, 'notificaciones_registros');
