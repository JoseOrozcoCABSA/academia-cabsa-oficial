/**
 * @file Controlador de `reminders`, sobre la tabla `notificaciones_recordatorios`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `notificaciones_recordatorios`.
 */
export default new ResourcesController(service, 'notificaciones_recordatorios');
