/**
 * @file Controlador de `templates`, sobre la tabla `notificaciones_plantillas`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `notificaciones_plantillas`.
 */
export default new ResourcesController(service, 'notificaciones_plantillas');
