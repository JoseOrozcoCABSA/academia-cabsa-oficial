/**
 * @file Repositorio de `roles`, sobre la tabla `usuarios_roles`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `usuarios_roles`.
 */
export default new ResourcesRepository('usuarios_roles');
