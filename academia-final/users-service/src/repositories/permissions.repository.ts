/**
 * @file Repositorio de `permissions`, sobre la tabla `usuarios_permisos`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `usuarios_permisos`.
 */
export default new ResourcesRepository('usuarios_permisos');
