/**
 * @file Controlador de `enrollments`, sobre la tabla `academia_inscripciones`.
 *
...
import service from '#services/enrollments.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `academia_inscripciones`.
 */
export default new ResourcesController(service, 'academia_inscripciones');
