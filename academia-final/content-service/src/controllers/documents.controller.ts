/**
 * @file Controlador de `documents`, sobre la tabla `contenido_recursos`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `contenido_recursos`.
 */
export default new ResourcesController(service, 'contenido_recursos');
