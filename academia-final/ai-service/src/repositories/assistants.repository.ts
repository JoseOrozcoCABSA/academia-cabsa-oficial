/**
 * @file Repositorio de `assistants`, sobre la tabla `ia_asistentes`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `ia_asistentes`.
 */
export default new ResourcesRepository('ia_asistentes');
