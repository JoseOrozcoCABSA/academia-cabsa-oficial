/**
 * @file Repositorio de `prompts`, sobre la tabla `ia_plantillas_prompts`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `ia_plantillas_prompts`.
 */
export default new ResourcesRepository('ia_plantillas_prompts');
