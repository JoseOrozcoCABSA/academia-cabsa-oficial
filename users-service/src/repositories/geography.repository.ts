/**
 * @file Repositorio de `geography`, sobre la tabla `usuarios_estados`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `usuarios_estados`.
 */
export default new ResourcesRepository('usuarios_estados');
