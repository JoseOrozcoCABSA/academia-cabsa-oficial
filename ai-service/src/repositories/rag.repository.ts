/**
 * @file Repositorio de `rag`, sobre la tabla `ia_bases_conocimiento_rag`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `ia_bases_conocimiento_rag`.
 */
export default new ResourcesRepository('ia_bases_conocimiento_rag');
