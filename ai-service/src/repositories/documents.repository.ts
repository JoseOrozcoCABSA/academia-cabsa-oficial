/**
 * @file Repositorio de `documents`, sobre la tabla `ia_documentos_rag`.
 *
...
/**
 * Instancia lista para usar, fijada a la tabla `ia_documentos_rag`.
 */
export default new ResourcesRepository('ia_documentos_rag');
