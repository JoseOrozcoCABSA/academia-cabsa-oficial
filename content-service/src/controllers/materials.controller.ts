/**
 * @file Controlador de `materials`, sobre la tabla `contenido_material_educativo`.
 *
...
import service from '#services/materials.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `contenido_material_educativo`.
 */
export default new ResourcesController(service, 'contenido_material_educativo');
