/**
 * @file Controlador de `capsules`, sobre la tabla `contenido_capsulas`.
 *
...
import service from '#services/capsules.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `contenido_capsulas`.
 */
export default new ResourcesController(service, 'contenido_capsulas');
