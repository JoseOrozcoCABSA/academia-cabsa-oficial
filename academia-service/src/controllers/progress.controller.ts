/**
 * @file Controlador de `progress`, sobre la tabla `academia_progreso_lecciones`.
 *
...
import service from '#services/progress.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `academia_progreso_lecciones`.
 */
export default new ResourcesController(service, 'academia_progreso_lecciones');
