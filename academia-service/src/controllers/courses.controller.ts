/**
 * @file Controlador de `courses`, sobre la tabla `academia_cursos`.
 *
...
import service from '#services/courses.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `academia_cursos`.
 */
export default new ResourcesController(service, 'academia_cursos');
