/**
 * @file Controlador de `memberships`, sobre la tabla `usuarios_becas`.
 *
...
import service from '#services/memberships.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `usuarios_becas`.
 */
export default new ResourcesController(service, 'usuarios_becas');
