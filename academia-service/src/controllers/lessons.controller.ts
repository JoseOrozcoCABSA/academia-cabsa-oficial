/**
 * @file Controlador de `lessons`, sobre la tabla `academia_lecciones`.
 *
...
import service from '#services/lessons.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `academia_lecciones`.
 */
export default new ResourcesController(service, 'academia_lecciones');
