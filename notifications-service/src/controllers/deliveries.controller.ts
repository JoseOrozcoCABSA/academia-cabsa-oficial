/**
 * @file Controlador de `deliveries`, sobre la tabla `notificaciones_intentos_entrega`.
 *
...
import service from '#services/deliveries.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `notificaciones_intentos_entrega`.
 */
export default new ResourcesController(service, 'notificaciones_intentos_entrega');
