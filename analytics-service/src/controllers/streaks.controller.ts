/**
 * @file Controlador de `streaks`, sobre la tabla `analitica_rachas`.
 *
...
import service from '#services/streaks.service';
import { ResourcesController } from '#controllers/resources.controller';

/**
 * Instancia lista para usar, fijada a la tabla `analitica_rachas`.
 */
export default new ResourcesController(service, 'analitica_rachas');
